...
<section class="table-filter">
    <form name="filter" action="<?=$formby?>/search.php" method="POST" enctype="multipart/form-data" target="_blank">
...
<script type="text/javascript">
    function manage_events(action, params){
        if(action=='new'){
            ...
            $("#ManageDialog").load("<?=$formby?>/scripts/new.php", params, function(response, status, xhr){
                if(status=="error"){
            ...
            params['form_as'] = '<?=$formby?>';
            $("#ManageDialog").load("<?=$formby?>/scripts/edit.php", params, function(response, status, xhr){
                if(status=="error"){
                    $(this).html('<div class="modal-dialog modal-dialog-centered modal-sm"><div class="modal-content text-center">'+xhr.status + "<br>" + xhr.statusText+'<div class="modal-body"></div></div></div>');
                }else{
                    $("#ManageDialog").modal('show');
