                ...
                <div class="alert alert-info alert-icon mb-2" style="padding:5px 15px;">
                    <div class="mb-1">
                        <div class="form-control on-text-display">
                            ...
                            <div style="float:left;margin:-15px 5px 0 -10px;"><span class="fs-32 uil uil-envelopes"></span></div>
                            <b class="fs-16"><?=((isset($data['email'])&&$data['email'])?$data['email']:'-')?></b>
                        </div>
                    </div>
                    <div class="row gx-1 on-info" style="display:none;">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-floating mb-1">
                                <div class="form-control on-text-display"><?=((isset($data['user_role'])&&$data['user_role'])?$data['user_role']:$data['-'])?></div>
                                <label><?=Lang::get('Permission')?></label>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="form-floating mb-1">
                                <div class="form-control on-text-display"><?=((isset($data['date_create'])&&$data['date_create'])?$data['date_create']:$data['-'])?></div>
                                <label><?=Lang::get('Date-Time')?></label>
                            </div>
                        </div>
                    </div>
                </div>
